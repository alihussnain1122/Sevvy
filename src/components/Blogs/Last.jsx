    ...
    <section>
      <div className="max-w-6xl mx-auto px-2 sm:px-4">
        ...
        <div className="relative overflow-hidden rounded-xl sm:rounded-2xl">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center text-center py-4 sm:py-6 md:py-8 lg:py-10 px-2 sm:px-6 md:px-12">
            ...
            <h2 className="mt-2 text-xl sm:text-2xl md:text-4xl lg:text-4xl text-white mb-2 sm:mb-3 md:mb-4 leading-tight break-words max-w-xs sm:max-w-md md:max-w-2xl">
              ...
              <span className="bg-gradient-to-r from-orange-500 via-orange-500 to-orange-200 bg-clip-text text-transparent italic font-Instrument whitespace-nowrap">Creative System</span>
            </h2>
            ...
            <p className="text-xs sm:text-sm md:text-base text-white/90 max-w-[95vw] sm:max-w-xl mx-auto mb-4 sm:mb-6 md:mb-8 leading-relaxed">
              High-performing teams don’t rely on talent alone. They rely on structure, clarity, and speed. See how Sevvy turns content workflows into predictable operations.
            </p>
