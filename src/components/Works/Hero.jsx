  ...
  return (
    <section className="w-full py-20 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative flex justify-center items-center mx-auto mt-0 mb-8 max-w-5xl" style={{minHeight: '520px'}}>
          ...
          <img 
            ...
            className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-[45%] w-[70%] max-w-[620px] h-auto object-contain z-10 pointer-events-none select-none"
          />

          {/* Layer 3 (topmost): character.webp + "How Sevvy Works" text */}
          <div className="relative z-20 flex items-start justify-center gap-4 md:gap-6 -mt-16">
            <img 
              src="/HowItWorks/hero/character.webp" 
              alt="Sevvy Character" 
              className="w-36 md:w-44 lg:w-52 h-auto drop-shadow-2xl"
            />
            <h3 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-[#FF8A3D] leading-tight text-left pt-4 md:pt-6">
              How Sevvy<br />Works
            </h3>
          </div>
        </div>
        ...
        {/* --- Bottom Buttons --- */}
        <div className="flex flex-col sm:flex-row justify-center items-center gap-5 mt-16 relative z-40">
