  ...
  return (
    <section className="w-full py-8 px-6 mb-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <button onClick={() => { window.location.href = 'https://work.sevvy.app/login'; }} className="bg-gradient-to-r from-orange-500 to-orange-200 hover:bg-[#FF7A2D] text-white font-semibold px-8 py-4 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 text-base md:text-lg cursor-pointer hover:shadow-orange-200 hover:scale-105">
            Start Your Creative Workflow
          </button>

          <button onClick={() => { window.location.href = 'https://work.sevvy.app/login'; }} className="border-2 border-[#FF8A3D] text-[#FF8A3D] bg-white  font-semibold px-8 py-4 rounded-2xl flex items-center gap-3 text-base md:text-lg transition-all duration-300 cursor-pointer hover:shadow-xl hover:scale-105">
