...
<a href="https://work.sevvy.app/login" target="_blank" rel="noopener noreferrer">
          <button className="bg-gradient-to-r from-orange-500 to-orange-200 hover:bg-[#FF7A2D] text-white font-semibold px-8 py-4 md:px-6 md:py-3 lg:px-8 lg:py-4 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 text-base lg:text-lg cursor-pointer hover:shadow-orange-200 hover:scale-105">
            Start Your Creative Workflow
          </button>
          </a>

<a href="https://work.sevvy.app/login" target="_blank" rel="noopener noreferrer">
          <button className="border-2 border-[#FF8A3D] text-[#FF8A3D] bg-white font-semibold px-8 py-4 md:px-5 md:py-2 lg:px-8 lg:py-4 rounded-2xl flex items-center gap-3 text-base md:text-sm lg:text-lg transition-all duration-300 cursor-pointer hover:shadow-xl hover:scale-105">
