        ...
        <div className="flex items-center gap-3">
          ...
          {shareLinks.map((link) => (
            <a
              ...
              className="w-9 h-9 rounded-full bg-orange-100 text-orange-500 flex items-center justify-center hover:bg-orange-500 hover:text-white transition-colors duration-200"
            >
              {link.icon}
            </a>
          ))}
