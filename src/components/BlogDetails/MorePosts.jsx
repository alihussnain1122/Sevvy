  ...
  return (
    <div className="mt-16">
      ...
      <div className="flex justify-center mt-10">
        <Link
          to="/blog"
          className="bg-gradient-to-r from-orange-500 to-orange-200 hover:scale-105 hover:shadow-xl hover:shadow-orange-200  text-white font-semibold px-8 py-3 rounded-full transition-colors duration-200"
        >
          Learn More
        </Link>
      </div>
