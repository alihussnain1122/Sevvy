      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 space-y-4 lg:space-y-8">
        ...
        <div className="relative rounded-2xl p-8 lg:p-12 overflow-hidden bg-[rgb(255,251,248)]">
          ...
          <div className="relative z-10  grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            {/* Right - Premium Card */}
            <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-orange-400 max-w-md mx-auto">
        ...
        <div className="bg-white rounded-3xl p-8 lg:p-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 order-1 md:order-none">
              ...
              <button className="bg-gradient-to-r from-orange-500 to-orange-200 text-white font-medium py-3 px-8 rounded-xl transition-shadow inline-flex items-center gap-2 cursor-pointer ">
                Upgrade Now
                <span>→</span>
              </button>
            </div>
