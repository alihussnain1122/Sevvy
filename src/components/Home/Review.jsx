    ...
    <section className="py-12 ">
      <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-12 md:mt-16 ">
            <button onClick={() => navigate('/blog')} className="inline-flex items-center bg-gradient-to-r from-orange-500 to-orange-200 font-bold text-white px-6 md:px-8 py-2.5 md:py-3 rounded-full hover:scale-105 transition-transform duration-300 md:text-base cursor-pointer hover:shadow-xl hover:shadow-orange-200">
