    ...
    <section className="w-full bg-white py-16">
      <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="lg:hidden mt-14 flex flex-col items-center justify-center">
            ...
            <div className="w-55 xs:w-[260px] sm:w-[320px] mb-2">
              <img
          ...
          <div className="flex flex-row w-full justify-center gap-2 mb-2">
            <div className="w-30 xs:w-[140px] sm:w-40">
              <img
            ...
            <div className="w-25 xs:w-[120px] sm:w-35">
              <img
          ...
          /* Team image at last */}
          <div className="w-55 xs:w-[260px] sm:w-[320px] mt-2">
            <img
          ...
          {/* CTA Button */}
          <button className="mt-8 rounded-2xl bg-linear-to-r from-orange-500 to-orange-300 px-8 py-3 text-sm font-semibold text-white shadow-xl transition duration-300 hover:from-orange-600 hover:to-orange-400 w-full max-w-xs mx-auto">
        ...
        <div className="hidden lg:flex relative mt-14 flex-row items-center justify-center">
          ...
          <div className="relative z-10 flex flex-col items-center mx-auto">
            ...
            />
            <div className="relative mt-2 w-65 left-10">
              <img
                src="/WhoIsSevvy/Hero/Card.webp"
                alt="Customers card"
                className="w-full object-contain drop-shadow-xl"
            ...
            <button className="mt-16 rounded-2xl bg-linear-to-r from-orange-500 to-orange-300 px-16 py-4 text-base font-semibold text-white shadow-xl transition duration-300 hover:from-orange-600 hover:to-orange-400 hover:scale-105">
              Get 14 Days Free Trial
            </button>
          </div>
          {/* Right Side Team Card */}
          <div className="flex flex-col items-center mt-10 absolute right-32.5 top-24 w-90">
            <img
              src="/WhoIsSevvy/Hero/team.webp"
              alt="Team list"
              className="w-full object-contain"
