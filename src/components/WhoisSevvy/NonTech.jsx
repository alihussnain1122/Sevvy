        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start mb-16">
          ...
          >
            <p className="text-gray-700 text-base md:text-lg leading-relaxed max-w-md">
              Many creative teams abandon traditional PM tools because they feel rigid or overly technical. Sevvy is designed for visual, iterative workflows, not checklist-heavy systems that slow adoption.
            </p>
          </motion.div>
